...
<template>
  <div>
    ...
    >
      ...
      <vxe-column field="name" title="科室" type="html" sortable />
      <vxe-column field="responsible" title="责任人" type="html" sortable />
      <vxe-column field="description" title="功能说明" type="html" />
      <vxe-column field="process" title="操作流程" type="html" />
      <vxe-column field="content" title="功能说明" type="html" />
    ...
    >
      <template #default>
        <vxe-form :data="formData" :rules="formRules" title-align="right" title-width="100" @submit="submitEvent">
          ...
          <vxe-form-item field="responsible" title="责任人" :span="12" :item-render="{}">
            <template #default="{ data }">
              <vxe-input v-model="data.responsible" placeholder="请输入责任人" />
            </template>
          </vxe-form-item>
          <vxe-form-item field="description" title="功能说明" :span="24" :item-render="{}" :title-suffix="{message: '请输入功能说明', icon: 'vxe-icon-question-circle-fill'}">
            <template #default="{ data }">
              <vxe-textarea v-model="data.description" :autosize="{minRows: 2, maxRows: 4}" />
            </template>
          </vxe-form-item>
          <vxe-form-item field="process" title="操作流程" :span="24" :item-render="{}" :title-suffix="{message: '请输入操作流程', icon: 'vxe-icon-question-circle-fill'}">
            <template #default="{ data }">
              <vxe-textarea v-model="data.process" :autosize="{minRows: 2, maxRows: 4}" />
            </template>
          </vxe-form-item>
          <vxe-form-item field="content" title="工作内容" :span="24" :item-render="{}" :title-suffix="{message: '请输入工作内容', icon: 'vxe-icon-question-circle-fill'}">
            <template #default="{ data }">
...
export default {
  data() {
    return {
      ...
      submitLoading: false,
      initialTableData: [
        { id: 10001, name: 'JZY', responsible: '示例', description: '示例', process: '示例', content: '示例' },
        { id: 10001, name: 'JZY', responsible: '示例', description: '示例', process: '示例', content: '示例' },
        { id: 10001, name: 'JZY', responsible: '示例', description: '示例', process: '示例', content: '示例' },
        { id: 10001, name: 'JZY', responsible: '示例', description: '示例', process: '示例', content: '示例' },
        { id: 10001, name: 'JZY', responsible: '示例', description: '示例', process: '示例', content: '示例' },
